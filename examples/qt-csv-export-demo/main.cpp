...
int main(int argc, char *argv[])
{
    ...
    {
        qDebug()    << "ValueDate:"    <<  row[camt::to_index(camt::ExportField::ValueDate)].second
                    << "BookingDate:"  <<  row[camt::to_index(camt::ExportField::BookingDate)].second
                    << "Amount:"       <<  row[camt::to_index(camt::ExportField::Amount)].second;
    }
